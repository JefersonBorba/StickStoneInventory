...
public class ProductCursorAdapter extends CursorAdapter {
    ...
    public void bindView(View view, final Context context, Cursor cursor) {
        ...
        float price = cursor.getFloat(cursor.getColumnIndex(ProductContract.ProductEntry.COLUMN_PRODUCT_PRICE));
        final int quantity = cursor.getInt(cursor.getColumnIndex(ProductContract.ProductEntry.COLUMN_PRODUCT_STOCK));
        ...
        saleButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (quantity > 0) {
                    ...
                    values.put(ProductContract.ProductEntry.COLUMN_PRODUCT_STOCK, newQuantity);
