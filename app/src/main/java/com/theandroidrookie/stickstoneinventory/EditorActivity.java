package com.theandroidrookie.stickstoneinventory;
...
import com.theandroidrookie.stickstoneinventory.data.ProductContract;
...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public void onLoaderReset(Loader<Cursor> loader) {
        ...
        mCategorySpinner.setSelection(ProductContract.ProductEntry.CATEGORY_MOBILE);
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (!TextUtils.isEmpty(selection)) {
                    if (selection.equals(getString(R.string.category_mobile))) {
                        mCategory = ProductContract.ProductEntry.CATEGORY_MOBILE; // Male
                    } else if (selection.equals(getString(R.string.category_laptop))) {
                        mCategory = ProductContract.ProductEntry.CATEGORY_LAPTOP; // Female
                    } else {
                        mCategory = ProductContract.ProductEntry.CATEGORY_TELEVISION; // Unknown
                    }
                }
            }
    ...
    private void saveProduct() {
        ...
        values.put(ProductContract.ProductEntry.COLUMN_PRODUCT_BRAND, brand);
        values.put(ProductContract.ProductEntry.COLUMN_PRODUCT_CATEGORY, category);
        values.put(ProductContract.ProductEntry.COLUMN_PRODUCT_PRICE, price);
        values.put(ProductContract.ProductEntry.COLUMN_PRODUCT_PRICE_DISCOUNT, discount);
        values.put(ProductContract.ProductEntry.COLUMN_PRODUCT_STOCK, stock);
        values.put(ProductContract.ProductEntry.COLUMN_PRODUCT_IMAGE, image);
        values.put(ProductContract.ProductEntry.COLUMN_PRODUCT_SUPPLIER_NAME, suppName);
        values.put(ProductContract.ProductEntry.COLUMN_PRODUCT_SUPPLIER_EMAIL, suppEmail);
        values.put(ProductContract.ProductEntry.COLUMN_PRODUCT_SUPPLIER_PHONE, suppPhone);
